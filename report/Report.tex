...
\begin{itemize}
    ...
    % \item \textbf{Smart Contract:} Facilitates secure and verifiable interactions on the blockchain.
    % \item \textbf{Firestore Database:} Central storage for user and file data.
    % \item \textbf{Ethereum Network:} The blockchain network where the smart contract is deployed.
\end{itemize}
\begin{figure}[hbtp]
\centering
